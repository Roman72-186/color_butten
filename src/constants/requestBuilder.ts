...
export const REQUEST_METHODS: RequestMethodConfig[] = [
  ...
  },
  {
    ...
    description: 'Переслать одно сообщение',
    category: 'forward',
    supportsDirectMessagesTopic: true,
    hint: 'Пересылает сообщение с указанием исходного чата.',
  },
  {
    id: 'forwardMessages',
    title: 'forwardMessages',
    description: 'Переслать несколько сообщений',
    category: 'forward',
    supportsDirectMessagesTopic: true,
    hint: 'Пересылает до 100 сообщений по массиву message_ids.',
  },
  {
    id: 'copyMessage',
    title: 'copyMessage',
    description: 'Скопировать одно сообщение',
    category: 'copy',
    supportsParseMode: true,
    supportsShowCaptionAboveMedia: true,
    supportsDirectMessagesTopic: true,
    supportsInlineKeyboard: true,
    hint: 'Копирует сообщение без ссылки на исходный чат. Можно переопределить caption.',
  },
  {
    id: 'copyMessages',
    title: 'copyMessages',
    description: 'Скопировать несколько сообщений',
    category: 'copy',
    supportsDirectMessagesTopic: true,
    hint: 'Копирует до 100 сообщений по массиву message_ids без ссылки на исходный чат.',
  },
  // ── ПОЛУЧЕНИЕ ДАННЫХ ─────────────────────────────────────────────────────
  {
    id: 'getMe',
  ...
  },
  {
    ...
    description: 'Изменить подпись media',
    category: 'updating',
    supportsParseMode: true,
    supportsShowCaptionAboveMedia: true,
    supportsInlineKeyboard: true,
  },
  {
    ...
    description: 'Заменить media',
    category: 'updating',
    supportsParseMode: true,
    supportsShowCaptionAboveMedia: true,
    supportsInlineKeyboard: true,
    hint: 'Для обычного сообщения нужны chat_id и message_id; для inline-сообщения заполните inline_message_id.',
  },
  {
    id: 'editMessageLiveLocation',
    title: 'editMessageLiveLocation',
    description: 'Изменить live location',
    category: 'updating',
    supportsInlineKeyboard: true,
  },
  {
    id: 'stopMessageLiveLocation',
    title: 'stopMessageLiveLocation',
    description: 'Остановить live location',
    category: 'updating',
    supportsInlineKeyboard: true,
  },
  {
    ...
    description: 'Изменить checklist',
    category: 'updating',
    supportsInlineKeyboard: true,
    hint: 'Checklist задается JSON-объектом. Метод работает с бизнес-сообщениями.',
  },
  {
    id: 'editMessageReplyMarkup',
    title: 'editMessageReplyMarkup',
    description: 'Изменить inline-клавиатуру',
    category: 'updating',
    supportsInlineKeyboard: true,
  },
  {
  ...
  },
  {
    ...
    title: 'approveSuggestedPost',
    description: 'Одобрить suggested post',
    category: 'updating',
    hint: 'Метод для suggested posts в direct messages chats. send_date можно оставить пустым.',
  },
  {
    id: 'declineSuggestedPost',
    title: 'declineSuggestedPost',
    description: 'Отклонить suggested post',
    category: 'updating',
    hint: 'Метод для suggested posts в direct messages chats. comment можно оставить пустым.',
  },
  {
    id: 'deleteMessage',
    title: 'deleteMessage',
    description: 'Удалить одно сообщение',
    category: 'updating',
  },
  {
    id: 'deleteMessages',
