  ...
  return (
    <div className={styles.formatter}>
      ...
      <AiDictationPanel
        ...
        existingText={text}
        hint="Поле пустое – надиктуй текст и что в нём выделить: например, «жирным напиши Акция до пятницы, дальше обычным текстом условия». Текст уже есть – скажи только, что выделить: «это выдели жирным», «здесь перенос строки». Текст останется как есть, поменяется только оформление."
